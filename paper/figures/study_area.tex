\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/Study Area (MS Only).pdf}
    ...
    \caption{Color-infrared NAIP imagery (left) and corresponding NLCD land cover data (right) over the state of Mississippi, USA.}\label{fig:study_area}
