"""Model zoo for land-cover segmentation and self-supervised pretraining.

This module intentionally contains many architecture variants used across
experiments. Not every class is active in current training scripts; see the
handoff audit document for likely-unused variants.
"""
