  ...
  # fi
    ...
    for scheme in "${PRETRAIN_SCHEMES[@]}"; do
      ...
      for band in "${BANDS[@]}"; do
        ...
        LOG_DIR="./logs/pretrain/resnet101_202506/${scheme}_bands${band}_size${size}_randinit${rand_init}"
        WEIGHTS_DIR="./weights/resnet101_202506/${scheme}_bands${band}_size${size}_randinit${rand_init}"
