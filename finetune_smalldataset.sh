...
BASE_LOG_DIR="./logs/finetune_smalldataset_20250925"
BASE_WEIGHTS_DIR="./weights/finetune_smalldataset_20250925"
SLURM_SCRIPT_DIR="./slurm_scripts/finetune_smalldataset_20250925"
SPLIT_DIR="./data/small_splits"
MAX_JOBS=10
